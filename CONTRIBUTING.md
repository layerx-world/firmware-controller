# Contributing to firware-controller
...
You can create issues [here](https://github.com/layerx-world/firware-controller/issues/new). When
...
* Please try your best to follow
  ...
  messages.
* We also require adding emoji prefixes to commit messages. You can either use
...
In all firware-controller-related forums, we follow the
[Rust Code of Conduct](https://www.rust-lang.org/conduct.html). For escalation or moderation issues
please contact Zeeshan (zeenix@gmail.com) and/or Max Grollmann <max@grollmann.com> instead of the
