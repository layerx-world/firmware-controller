...
### Added
- ✨ Add tokio feature for std environment support.

### Changed
- 🏗️ Split macro into a separate sub-crate, firmware-controller-macros.

### Fixed
- 🩹 Remove an unnecessary `mut`.

### Other
- 🦺 Embrace singleton behavior & remove the footgun.
